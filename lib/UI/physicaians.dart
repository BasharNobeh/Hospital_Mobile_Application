...
class _MyHomePage extends State<Physicainas> {
    ...
    if (isLoading) {
      ...
      return Scaffold(
        ...
        child: Column(
          children: [
            searchCard(context),
            showGrid ? doctorGridView(context) : doctorListView(context),
          ],
        ),
      ));
    }
  ...
  Widget doctorGridView(BuildContext context) {
    var lang = Provider.of<Language>(context, listen: true);
    double height = MediaQuery.of(context).size.height;
    double width = MediaQuery.of(context).size.width;
    ...
    return Container(
        ...
        child: Column(
          children: [
            ...
            TextField(
              textAlign:
                  lang.getLanguage() == 'AR' ? TextAlign.end : TextAlign.start,
              controller: doctorTextController,
              decoration: InputDecoration(
                prefixIcon: const Icon(Icons.search),
                hintText: lang.tSearchbyname(),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                prefixIcon: const Icon(Icons.search),
                hintText: lang.tSearchbyspeciality(),
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(30),
                  borderSide: const BorderSide(color: Colors.black),
                ),
